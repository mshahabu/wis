...
function signin() {
	...
	print "<tr> <td><input type=radio name='signin_as'  value=1 checked='yes' > Student </td>";
	print "     <td><input type=radio name='signin_as'  value=2 checked='yes' > Teacher </td>";
	print "     <td><input type=radio name='signin_as'  value=3 checked='yes' > Staff   </td></tr>";
	print '</table>';
